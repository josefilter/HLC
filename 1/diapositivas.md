...
Hay aplicaciones que solo tienen frontend, pero la mayoria tienen frontend y backend.
Tecnologias para desarrollar en backend:
	-php
	-jsp
	-asp
	-ruby
	-python
	-nodejs
Framework del lado servidor:
	-laravel: Para php. (Tambien se puede utilizar symfony)
	-spring: Para java
	-asp.net: para asp
	-rails: ruby
	-django: python (Tambien se puede utilizar flask)
	-express: nodejs

Tecnologias para desarrollar en frontend:
	-JavaScript
Framework del lado cliente:
	-React
	-Angular
	-Vue

TypeScript se utiliza con el framework de angular

Transpirar es pasar de typescript a JavaScript o pasar de JavaScript8 a JavaScript6

Modelo Vista Controlador (MVC) es un patron de diseño que se usa mucho. Se ejecuta casi todo en el backend.
Se divide la aplicacion en tres partes:
	-Vista: Responde visualmente al usuario.
	-Modelo: Se conecta con la base de datos. Se puede hacer con java. Le envia los datos a la vista.
	-Controlador: Atiende las peticiones del usuario. 
